//
//  LXCompleteOrderViewController.m
//  Advertisement
//
...
static NSString *const LXCompleteOrdetVCTableViewCellID = @"LXCompleteOrdetVCTableViewCellID";

@interface LXCompleteOrderViewController () <UITableViewDelegate, UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    LXWaitOrdetVCTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:LXCompleteOrdetVCTableViewCellID];
...
//    待评价
//    已评价
    LXOrderDetailViewController *odVC = [[LXOrderDetailViewController alloc] initWithType:LXReservationBottomTypeWaitCommentOrder];
